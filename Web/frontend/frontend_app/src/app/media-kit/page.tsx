        ...
        <main className="w-full bg-white pb-20">
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-10">
                <div className="relative overflow-hidden rounded-3xl bg-slate-900 min-h-[320px] flex items-center p-8 lg:p-16">
                    <Image
                        alt="Abstract aerial view of logistics shipping routes"
            ...
            <section className="mt-20 max-w-7xl mx-auto px-6 lg:px-10">
                <div className="flex items-end justify-between border-b border-slate-200 pb-4 mb-8">
                    <div>
                        <h2 className="text-2xl font-black tracking-tighter text-slate-900 font-primary">Image Gallery</h2>
                        <p className="text-slate-600 mt-1 font-sans font-medium">Professional photography of our fleet and leadership.</p>
                    </div>
                    <button className="text-[#a1dc84] font-black flex items-center gap-1 hover:gap-2 transition-all">
                        View All <span className="material-symbols-outlined text-sm">arrow_forward_ios</span>
                    </button>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {[
                        { src: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=2070&auto=format&fit=crop", title: "Logistics Fleet - 2024 Series" },
                        { src: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=2071&auto=format&fit=crop", title: "Executive Leadership Portrait" },
                        { src: "https://images.unsplash.com/photo-1494412519320-aa613dfb7738?q=80&w=2070&auto=format&fit=crop", title: "Intermodal Maritime Freight" },
                        { src: "https://images.unsplash.com/photo-1553413077-190dd305871c?q=80&w=2070&auto=format&fit=crop", title: "Automated Sorting Center" }
                    ].map((img, idx) => (
                        <motion.div
                            key={idx}
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <button className="bg-[#a1dc84] text-slate-900 p-3 rounded-full shadow-lg hover:scale-110 transition-transform">
