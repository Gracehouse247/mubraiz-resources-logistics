...
export default function HaulageContent() {
    ...
    const handleAuditSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/contact/haulage-audit`, {
                method: 'POST',
            ...
            console.error('Haulage audit submission error:', error);
        } finally {
