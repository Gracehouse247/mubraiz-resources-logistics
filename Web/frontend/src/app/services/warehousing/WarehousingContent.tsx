...
export default function WarehousingContent() {
    ...
    const handleBriefSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/contact/warehousing-brief`, {
                method: 'POST',
            ...
            console.error('Warehousing brief submission error:', error);
        } finally {
